...
class __TwigTemplate_93e713b3df5c93718940b1c20dd4048a2e79358b39c7220d310315cc9a189ba9 extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 20
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["address"]) || array_key_exists("address", $context) ? $context["address"] : (function () { throw new RuntimeError('Variable "address" does not exist.', 20, $this->source); })()), "campany", [], "any", false, false, false, 20), "html", null, true);
        echo "</td>
            </tr>
            <tr>
                <th>Address</th>
...
{% endblock %}
", "address/show.html.twig", "/Users/mac/Desktop/AppSymfony/jstore/templates/address/show.html.twig");
    }
}
